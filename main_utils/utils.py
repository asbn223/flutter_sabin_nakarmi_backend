...
def create_mock_data():
    ...
    Metric.objects.bulk_create([
        Metric(name="Revenue", value=12450.75),
        Metric(name="Expenses", value=8450.50),
        Metric(name="Profit", value=4000.25),
        Metric(name="Customer Satisfaction", value=87.2),
        Metric(name="Conversion Rate", value=6.4)
    ])
